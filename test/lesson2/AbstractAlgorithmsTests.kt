...
Но вреден север для меня
        ...
        assertEquals(
            "тест", longestCommonSubstring(
                "Тут такой длинный тест был сверху",
                "Что я не знаю, что ещё тут можно протестировать"
            )
        )
        assertEquals(
            "рО", longestCommonSubstring(
                "ПрОтЕсТиРуЮ рЕгИсТрЫ, ПоЖаЛуЙ",
                "пРоТеСтИрОвАл"
            )
        )
    }
